...
function addProvEntityTriplesDbl(provObject, ignore, store, section, singular, recordWriter, altSubj) {
    var entityCollection = provObject[section];
    for (var entity in  entityCollection) {
        if (shouldBeAdded(entityCollection, ignore, entity, singular)) {
...
function storeProvInN3(store, provObject, ignore) {
    ...
    addProvEntityTriplesDbl(provObject, ignore, store, 'attributions', 'wasAttributedTo', addAttributionRecords, "prov:entity");
    addProvEntityTriplesDbl(provObject, ignore, store, 'associations', 'wasAssociatedWith', addAssociationRecords, "prov:activity");
    ...
    addProvEntityTriplesDbl(provObject, ignore, store, 'generations', 'wasGeneratedBy', addGenerationsRecords,  "prov:entity");
    addProvEntityTriplesDbl(provObject, ignore, store, 'usages', 'used', addUsageRecords,  "prov:activity");
    addProvEntityTriplesDbl(provObject, ignore, store, 'derivations', 'wasDerivedFrom', addDerivationRecords,  "prov:generatedEntity");
    addProvEntityTriplesDbl(provObject, ignore, store, 'invalidations', 'wasInvalidatedBy', addInvalidationRecords,  "prov:entity");
